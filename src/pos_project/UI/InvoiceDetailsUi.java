 ...
 * @author Cif3r
 */
public class InvoiceDetailsUi extends javax.swing.JDialog implements Printable{
 private boolean outFlg = false;
    ...
    public InvoiceDetailsUi(java.awt.Frame parent, boolean modal, boolean isOut, String invoiceNumber) {
        super(parent, modal);
        initComponents();
...
//        }
    ...
    private void initComponents() {
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 5, 3, 5);
        getContentPane().add(locationTitle, gridBagConstraints);

        locationTextField.setText("jLabel8");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(0, 5, 0, 0);
        getContentPane().add(locationTextField, gridBagConstraints);
...
//             posType = Integer.parseInt(prop.getProperty("posType"));
//                        
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
//          switch(posType){
//              case 1: GHprint(graphics, pageFormat, pageIndex);
//                  break;
//              default: SJprint(graphics, pageFormat, pageIndex);
//          }
//
//        return PAGE_EXISTS;
//    }
     ...
     public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
      ...
      switch(posType){
          ...
          default:
            ...
            row+=lineHeight*3;
            row+=lineHeight;
            g2d.drawString("Location: "+locationTextField.getText(), 1, row);
            row+=lineHeight;
            g2d.drawString("Invoice No.: "+invoiceNumTextField.getText(), 1, row);
            g2d.drawString("Date: "+invoiceDateTextField.getText(), 370, row);
            row+=lineHeight;
            g2d.drawString("Payment Type: "+paymentTextField.getText(), 1, row);
            g2d.drawString("Due Date: "+dueDate.getText(), 370, row);
            row+=lineHeight*2;
            ...
            g2d.drawString(clientType+" No.: "+customerNumberLabel.getText(), 1, row);
            row+=lineHeight;
            g2d.drawString(clientType+" Name: "+customerNameLabel.getText(), 1, row);
            row+=lineHeight;
            g2d.drawString("Address: "+clientAddress.getText(), 1, row);
            row+=lineHeight*3;

            if (invoice.getInvoiceTypeFlag().equals(new Short("1")) || invoice.getInvoicePaymentType().equals(new Short("69")) ){
                g2d.drawString("Item Name", 1, row);
                g2d.drawString("Quantity ", quantityLabel, row);
                g2d.drawString("Amount ", amountLabel, row);
                g2d.drawString("Subtotal ", subTotalLabel, row);
            } 
            ...
            for(int i = 0; i < loops; i++){
                if(i < itemTable.getRowCount()){
                    g2d.drawString(itemTable.getValueAt(i, 0).toString(), 1, row);
                    g2d.drawString(PrintAction.rightAlignStringForHalf(itemTable.getValueAt(i, 1).toString(),7), quantityValue, row);
                    g2d.drawString(PrintAction.rightAlignStringForHalf(itemTable.getValueAt(i, 2).toString(), 13), amountValue, row);
                    g2d.drawString(PrintAction.rightAlignStringForHalf(itemTable.getValueAt(i, 3).toString(), 13), subTotalValue, row);
                }
                row+=lineHeight;
            }
            g2d.drawString("Total: ", totalLabel, row);
            g2d.drawString(PrintAction.rightAlignStringForHalf(totalValueLabel.getText(), 13), totalValue, row);
        
            row+=lineHeight*2;            

            String drivr = " ";
            if(invoice.getInvoiceDriver() != null){
                drivr = invoice.getInvoiceDriver();
            }
        
            String cashir = " ";
            if(invoice.getInvoiceAddUser() != null){
                cashir = invoice.getInvoiceAddUser();
            }
            if (invoice.getInvoiceTypeFlag().equals(new Short("1")) || invoice.getInvoicePaymentType().equals(new Short("69"))){
                g2d.drawString("Cashier: "+cashir, 1, row);
                g2d.drawString("  _______________________________", 35, row);
                g2d.drawString("Approved By: ", 345, row);
                g2d.drawString("  _______________________________", 400, row);
                row+=lineHeight*2;            
                g2d.drawString("Driver: "+drivr, 1, row);
                g2d.drawString("  ________________________________", 30, row);
                g2d.drawString("Received By: ", 345, row);
                g2d.drawString("  _______________________________", 400, row);
            } else {
                g2d.drawString("           "+cashir, 1, row);
                row+=lineHeight*2;            
                if(invoice.getInvoiceDriver() != null){
                     g2d.drawString("           "+drivr, 1, row);
                }
            }
          return PAGE_EXISTS;
          }
...
//     public int SJprint(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
////        BufferedImage img = null;
////        try {
////            img = ImageIO.read(getClass().getResource("/icons/angelHeartLogo.png"));
////        } catch (IOException ex) {
...
//             
//         }
////        g2d.drawString("         "+invoice.getInvoiceAddUser(), 1, y);
////        g2d.drawString("  _______________________________", 35, y);
////        g2d.drawString("Approved By: ", 345, y);
////        g2d.drawString(PrintAction.rightAlignString(totalValueLabel.getText(), 13), 425, y);
////        g2d.drawString("  _______________________________", 400, y);
...
//    }     
      ...
      public int GHprint(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
//        BufferedImage img = null;
//        try {
//            img = ImageIO.read(getClass().getResource("/icons/angelHeartLogo.png"));
//        } catch (IOException ex) {
