 ...
 * @author Cif3r
 */
public class PoDetailsUi extends javax.swing.JDialog implements Printable{
 private boolean outFlg = false;
    private String itemNumber;
//    ArrayList<Transaction> transactionList;
    ArrayList<PreorderTransaction> preorderTransactionList;
    Item item;
    Client client;
//    Invoice invoice;
    Preorder preorder;
    ...
    public PoDetailsUi(java.awt.Frame parent, boolean modal, boolean isOut, String invoiceNumber) {
        super(parent, modal);
        initComponents();
        
        preorder = Preorder.getPreorderWithId(invoiceNumber);
        Client loc = Client.getClient(preorder.getPreorderLocationId().toString());
...
//        paymentTextField.setText(InvoiceAction.getPaymentType(invoice.getInvoicePaymentType()));
        invoiceNumTextField.setText(preorder.getPreorderNumber());
//        GregorianCalendar cal = new GregorianCalendar();
//        cal.setTime(invoice.getInvoiceDate());
        invoiceDateTextField.setText(Formats.dateFormatDays2.format(preorder.getPreorderDate()));
...
//        }
        Client c = Client.getClient(preorder.getPreorderClientId().toString());
        customerNumberLabel.setText(c.getClientNumber());
        preorderTransactionList = PreorderTransaction.getTransactions(""+preorder.getPreorderId());
        initializeTable();
//        transactionList =
...
//                +PrintAction.addAfterSpaces("DATE: ", 5)+invoiceDateTextField.getText(),1,y);
        g2d.drawString("PO No.: "+invoiceNumTextField.getText(), 1, y);
...
//        }
            ...
            String cashier = " ";
        if(preorder.getPreorderAddUser() != null){
            cashier = preorder.getPreorderAddUser();
        }
//         if (invoice.getInvoiceTypeFlag().equals(new Short("1")) || invoice.getInvoicePaymentType().equals(new Short("69"))){
...
//             g2d.drawString(PrintAction.rightAlignString(totalValueLabel.getText(), 13), 425, y);
            ...
            g2d.drawString("Purpose: "+driver, 1, y);
...
//        }
        ...
        for(PreorderTransaction emp: preorderTransactionList){
...
//        checkClient();
        ...
        if(preorderTransactionList.isEmpty()){
            errorFlg = true;
