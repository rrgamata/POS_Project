 ...
 * @author Cif3r
 */
public class EditReturnUi extends javax.swing.JDialog {
 private boolean outFlg = false;
    private String itemNumber;
    ArrayList<Transaction> transactionList = new ArrayList<Transaction>();
//    ArrayList<Integer> deleteList = new ArrayList<Integer>();
    ArrayList<Transaction> deleteList = new ArrayList<Transaction>();
    ArrayList<Returns> returneList = new ArrayList<Returns>();
    ArrayList<Returns> returnDelList = new ArrayList<Returns>();
    Item item;
    Client client;
    Invoice invoice;
    
    /** Creates new form AddClient */
    public EditReturnUi(java.awt.Frame parent, boolean modal, boolean isOut, String invoiceNumber) {
        super(parent, modal);
...
//        transactionList = Transaction.getTransactions(""+invoice.getInvoiceId());
        returneList = Returns.getReturns(""+invoice.getInvoiceId());
        initializeTable();
//        transactionList =
        ...
        ReturnsItemUi detailsPopUp;
            ...
            detailsPopUp = new ReturnsItemUi(new JFrame(),true,invoice.getInvoiceId());
                ...
                if( detailsPopUp.getReturns() != null){
                    returneList.add( detailsPopUp.getReturns());
                }
                initializeTable();
...
//            deleteList.add(transactionList.get(itemTable.getSelectedRow()).getTransactionId());
            returnDelList.add(returneList.get(itemTable.getSelectedRow()));
            returneList.remove(itemTable.getSelectedRow());
            initializeTable();
        } else {
...
//            }
            ...
            ReturnAction.returnSQLLogic(invoice.getInvoiceId(), totalValueLabel.getText(), returnNumberTextField.getText(), returneList, year, month, day, loc.getClientId(), outFlg, invoice);
...
//            InvoiceAction.invoiceEditSQLLogic(invoice.getInvoiceId(),client.getClientId(),totalValueLabel.getText(), transactionNumberTextField.getText(), receivableFlg, paymentComboBox.getSelectedIndex(), transactionList,year, month, day, outFlg, deleteList, loc.getClientId());
        }
        this.dispose();
