 ...
 * @author Cif3r
 */
public class PricelistUi extends javax.swing.JDialog {
...
// private Transaction transaction;
    ...
    public PricelistUi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initializeTable();
    }
    ...
    private void searchTable(int clientId){
        clientTable.getTableHeader().setReorderingAllowed(false);
        DefaultTableModel mod = ItemAction.getSpecificTableData(clientId);
        clientTableAdjust(mod, 3);
...
//    public PricelistUi(java.awt.Frame parent, Boolean modal, int searchType,boolean outFlag) {
//       initComponents();
...
//       }
//    }
//       public PricelistUi(java.awt.Frame parent, Boolean modal, int searchType, int supplierNumber){
//               initComponents();
//               this.searchType = searchType;
...
//     }
//      
//     public PricelistUi(java.awt.Frame parent, Boolean modal, int invoiceNumber){
//               initComponents();
//               this.searchType = 7;
...
//       
//       
//        public PricelistUi(java.awt.Frame parent, Boolean modal, int searchType, boolean outFlag, int locationNumber){
//               initComponents();
//               this.searchType = searchType;
...
//     }
//        
//        public PricelistUi(java.awt.Frame parent, Boolean modal, int searchType, boolean outFlag, Preorder po){
//               initComponents();
//               this.searchType = searchType;
...
//    public PricelistUi(java.awt.Frame parent, Boolean modal, boolean outFlag, int clientNumber){
//               initComponents();
//               this.searchType = 6;
...
//    }
    ...
    private void initComponents() {
        ...
        jButton3.setText("Generate Excel");
        ...
        getContentPane().add(detSalesSupplierNameLabel1, gridBagConstraints);
...
//        }
        ...
        generateExcel(clientTable.getModel(), "Pricelist", 0);
...
//                AddItemUi detailsPopUp3 = new AddItemUi(new JFrame(),true, false);
    ...
    private void jButton24ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton24ActionPerformed
        ...
        if(detailsPopUp.getClient() != null){
            ...
            searchTable(client.getClientId());
...
//                    }
                ...
                if(client == null){
                    ExcelAction.createPriceListXL(fileName+".xls", mod, title, "ALL");   
                } else {
                    ExcelAction.createPriceListXL(fileName+".xls", mod, title, client.getClientName());   
                }
